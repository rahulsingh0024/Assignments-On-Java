...
public class CountAndPrintDuplicateString {
    ...
    public static void main(String[] args) {
        ...
        CountAndPrintDuplicateString("SangamOne Connected Services Private Limited");
    }

    // print count of each character in a given string.
    private static void CountAndPrintDuplicateString(String input)
    {
